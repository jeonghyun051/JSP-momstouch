	...
	<div
		...
		<div
			...
			<ul style="width: auto; margin-right: 20px;">
				...
				<li style="width: 78px; margin-left: -10px;"><strong
					style="font-size: 12px; margin-top: 10px;">&nbsp; 음료 메뉴 </strong></li>
			</ul>
			<br> <br />
		</div>
		<br>
		<div style="display: flex; justify-content: space-evenly;">
			...
			<div style="text-align: center;">
				<a href="/momstouch/board?cmd=menudetail&id=13"><img
					src="/momstouch/images/drink1.png" width="200" height="180"
			...
			<%-- </c:forEach> --%>
			<div style="text-align: center;">
				<a href="/momstouch/board?cmd=menudetail&id=14"><img
					src="/momstouch/images/drink2.png" width="200" height="180"
					style="border: 4px solid beige; border-radius: 20px;"></a>
				<div>슈퍼베리워터주스</div>
			</div>
			<div style="text-align: center;">
				<a href="/momstouch/board?cmd=menudetail&id=15"><img
					src="/momstouch/images/drink3.png" width="200" height="180"
					style="border: 4px solid beige; border-radius: 20px;"></a>
				<div>레몬홍차</div>
			</div>
		</div>
		<div style="display: flex; justify-content: space-evenly;">
			<div style="text-align: center;">
				<a href="/momstouch/board?cmd=menudetail&id=16"><img
					src="/momstouch/images/drink4.png" width="200" height="180"
					style="border: 4px solid; border-radius: 20px"></a>
				<div>홍차</div>
			</div>
			<div style="text-align: center;">
				<a href="/momstouch/board?cmd=menudetail&id=17"><img
					src="/momstouch/images/drink5.png" width="200" height="180"
					style="border: 4px solid; border-radius: 20px"></a>
				<div>레몬에이드</div>
			</div>
			<div style="text-align: center;">
				<a href="/momstouch/board?cmd=menudetail&id=18"><img
					src="/momstouch/images/drink6.png" width="200" height="180"
					style="border: 4px solid; border-radius: 20px"></a>
				<div>레몬딸기스무디</div>
			</div>
		</div>

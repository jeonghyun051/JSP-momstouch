	...
	<div
		...
		<div
			...
			<ul style="width: auto; margin-right: 20px;">
				...
				<li style="width: 78px; margin-left: -10px;"><strong
					style="font-size: 12px; margin-top: 10px;">&nbsp; 치킨 메뉴 </strong></li>
			</ul>
			<br> <br />
		</div>
		<br>
		<div style="display: flex; justify-content: space-evenly;">
			...
			<div style="text-align: center;">
				<a href="/momstouch/board?cmd=menudetail&id=1"><img
					src="/momstouch/images/chicken1.png" width="200" height="180"
			...
			<%-- </c:forEach> --%>
			<div style="text-align: center;">
				<a href="/momstouch/board?cmd=menudetail&id=2"><img
					src="/momstouch/images/chicken2.png" width="200" height="180"
					style="border: 4px solid beige; border-radius: 20px;"></a>
				<div>내슈빌핫통다리</div>
			</div>
			<div style="text-align: center;">
				<a href="/momstouch/board?cmd=menudetail&id=3"><img
					src="/momstouch/images/chicken3.png" width="200" height="180"
					style="border: 4px solid beige; border-radius: 20px;"></a>
				<div>간장마늘치킨</div>
			</div>
		</div>
		<div style="display: flex; justify-content: space-evenly;">
			<div style="text-align: center;">
				<a href="/momstouch/board?cmd=menudetail&id=4"><img
					src="/momstouch/images/chicken4.png" width="200" height="180"
					style="border: 4px solid; border-radius: 20px"></a>
				<div>알룰로스치킨</div>
			</div>
			<div style="text-align: center;">
				<a href="/momstouch/board?cmd=menudetail&id=5"><img
					src="/momstouch/images/chicken5.png" width="200" height="180"
					style="border: 4px solid; border-radius: 20px"></a>
				<div>알룰로스텐더</div>
			</div>
			<div style="text-align: center;">
				<a href="/momstouch/board?cmd=menudetail&id=6"><img
					src="/momstouch/images/chicken6.png" width="200" height="180"
					style="border: 4px solid; border-radius: 20px"></a>
				<div>찜햇닭</div>
			</div>
		</div>

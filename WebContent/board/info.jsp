	...
	<div style="margin-left: 200px; position: absoul;">
		...
		<div>
			<a href="/momstouch/board?cmd=info&page=0"><img
				src="/momstouch/images/click_info.png" style="width: 174px;"></a>
		</div>

		<div style="margin-top: 13px;">
			<a href="/momstouch/board?cmd=inquiry&page=0&id=${sessionScope.principal.id}"><img alt="" src="/momstouch/images/aside2.png"
				...
				<div class="card col-md-12 m-2"
					...
					<div class="card-body"
						...
						<div style="width: 70px; text-align: end; margin-right: -20px;">
							<div style="font-size: 14px;">${boards.readCount}</div>
						</div>
					</div>
				</div>
			</c:forEach>
